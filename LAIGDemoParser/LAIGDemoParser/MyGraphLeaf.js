...
switch(this.type)
    {
        case 'rectangle':
            ...
            this.primitive = new Rectangle(graph.scene, P1, P2);
            break;
        ...
        case 'sphere':
            ...
            this.primitive = new Sphere(graph.scene, radius, parts_along_radius, parts_per_section);
            break;
        ...
        case 'triangle':
            ...
            this.primitive = new Triangle(graph.scene, P1, P2, P3);
            break;
        ...
        case 'cylinder':
            ...
            this.primitive = new Cylinder(graph.scene, height,  bottom_radius, top_radius, sections_along_height, parts_per_section);
            break;
        default:
            break;
    }
